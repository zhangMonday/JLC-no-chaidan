...
**欢迎体验我的新作 嘉立创自动签到脚本 ，可以每天自动领取开源平台的积分和嘉立创金豆，支持多账号处理。并提供通过Github Actions每天免费自动触发的教程。详见[https://github.com/zhangMonday/PCBfactory-auto-check-in](https://github.com/zhangMonday/PCBfactory-auto-check-in)**
